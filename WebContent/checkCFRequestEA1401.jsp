...
<form id="myform" class="forms-sample"  action="<%=path%>/EA1401FindByIdCFRequest.html" method="post">
<div class="col-10 grid-margin stretch-card" >
	<div class="card" style="width:60%;"align="center">
		<div class="card-body" style="width:60%;" align="center">
			<h4 align="center">审批申请</h4>
		       ...
		       <c:choose>
				  <c:when test="${ins.aac505 <'4'}">
					  <button type="submit" name="next" class="btn btn-success mr-2"
		                          onclick="onAgree('${ins.aac501}')" >同意</button>
		              <button type="submit" name="next" class="btn btn-success mr-2"
		                          onclick="unAgree('${ins.aac501}')" >不同意</button>
				  </c:when> 
				</c:choose>
				<button type="submit" name="next"  class="btn btn-secondary mr-2"
		          formaction="<%=path%>/EA1401QueryCFRequest.html" formnovalidate="formnovalidate">返回</button>
	  		</div>
		</div>
	</div>
 </div>
