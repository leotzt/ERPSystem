...
<div  style="width:100%" align="center">
	<form class="forms-sample"  id="myform" action="<%=path%>/EC0901ModifyActivity.html" method="post">
		<div class="col-10 grid-margin stretch-card" >
      		<div class="card" style="width:60%;"align="center">
           		<div class="card-body" style="width:60%;" align="center">
					<h3 align="center">活动修改</h3>
				    ...
				    <div class="form-group" align="left">
						...
						<e:text styleClass="form-control" id="aae103" name="aae103" required="true" defval="${subins.aae103}" />
				    </div>
				    <div class="form-group" align="left">
				    ...
				    <div class="form-group" align="left">
					     ...
					     <e:textarea styleClass="form-control" id="aac404" name="aac404" required="true" rows="10" cols="40"  defval="${subins.aac404}"/>
				    </div>
     			    <div class="form-group" align="center">
			           <c:if test="${param.aac303!=1 }">
				       <button type="submit" name="next" class="btn btn-success mr-2" 
				               formaction="<%=path%>/EC0901ModifyActivity.html?maac301=${param.maac301}">修改</button>
			           </c:if>
