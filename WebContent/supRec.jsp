...
<form id="showSupRec" action="<%=request.getContextPath()%>/eF0901.html" method="post">

    <h4 align="center">变更信息</h4>
    ...
    <div style="width:100%;margin-top: 25px;float:left" align="center" >
        <div class="form-group" align="center" >
            <button type="submit" name="next" class="btn btn-secondary mr-2"
                    formaction="<%=request.getContextPath()%>/eF0801.html">返回</button>
        </div>
    </div>
