...
<form class="form-sample"  id="store" action="" method="post"> 
		...
		<div class="card-body" style="width:60%;" align="center">
			...
			<div class="form-group" align="left">  
				<label for="aae103">教师编号  :</label>
     			<e:text styleClass="form-control" name="aae103" readonly="true" defval="${ins.aae103}" required="true"/>
  			</div>
  			<div class="form-group" align="left">  
				<label for="aae102">教师姓名  :</label>
    			<e:text styleClass="form-control" name="aae102" readonly="true" defval="${ins.aae102}" required="true" />
  			</div>
  			<div class="form-group" align="left">  
				<label for="aac1005">成果名称  :</label>
    			<e:text styleClass="form-control" name="aac1005" readonly="true" defval="${ins.aac1005}" required="true"/>
  			</div>
  			<div class="form-group" align="left">  
		    ...
		    <div class="form-group" align="left">  
				<e:textarea styleClass="form-control" name="aac1004" readonly="true"
				defval="${ins.aac1004}"  cols="40" rows="10"/>
		    </div>
   			<div class="form-group" align="center">
          		<button class="btn btn-secondary mr-2" type="submit" name="next"
              	formaction="<%=path%>/EA1201QueryRequestToLook.html" 
...
<e:hidden name="baac205"/>
<e:hidden name="eaac205"/>
